...
module "apim_itn_product_ioweb" {
  source = "git::https://github.com/pagopa/terraform-azurerm-v4.git//api_management_product?ref=v10.5.0"
...
module "apim_itn_spid_login_api" {
  source = "git::https://github.com/pagopa/terraform-azurerm-v4.git//api_management_api?ref=v10.5.0"
