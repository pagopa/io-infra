...
| <a name="input_storage"></a> [storage](#input\_storage) | n/a | <pre>object({<br>    enable_versioning             = bool<br>    delete_after_days             = number<br>    replication_type              = string<br>    enable_low_availability_alert = bool<br>  })</pre> | n/a | yes |
| <a name="input_subnets"></a> [subnets](#input\_subnets) | n/a | <pre>map(<br>    list(string)<br>  )</pre> | n/a | yes |
