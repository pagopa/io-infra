...
module "cosmos_cgn" {
  source   = "git::https://github.com/pagopa/terraform-azurerm-v3.git//cosmosdb_account?ref=v4.1.12"
...
module "cgn_cosmos_db" {
  source              = "git::https://github.com/pagopa/terraform-azurerm-v3.git//cosmosdb_sql_database?ref=v4.1.12"
  name                = "db"
  resource_group_name = data.azurerm_resource_group.rg_cgn.name
...
module "cgn_cosmosdb_containers" {
  source   = "git::https://github.com/pagopa/terraform-azurerm-v3.git//cosmosdb_sql_container?ref=v4.1.12"
...
module "cgn_legalbackup_storage" {
  source = "git::https://github.com/pagopa/terraform-azurerm-v3.git//storage_account?ref=v4.1.12"
