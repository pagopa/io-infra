...
module "vnet_weu_beta" {
  source               = "git::https://github.com/pagopa/terraform-azurerm-v3.git//virtual_network?ref=v4.1.16"
...
module "vnet_peering_common_weu_beta" {
  source = "git::https://github.com/pagopa/terraform-azurerm-v3.git//virtual_network_peering?ref=v4.1.16"
