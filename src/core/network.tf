...
module "vnet_common" {
  source               = "github.com/pagopa/terraform-azurerm-v3//virtual_network?ref=v8.26.5"
...
module "vnet_peering_common_weu_beta" {
  source = "github.com/pagopa/terraform-azurerm-v3//virtual_network_peering?ref=v8.26.5"
