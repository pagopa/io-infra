resource "azurerm_resource_group" "service_cache_rg" {
  name     = "${local.project}-plan-be-rg"
...
module "fn_service_cache_subnet" {
  ...
  name                 = "${local.fn_service_cache_subnet_name}"
...
#   resource_group_name                      = azurerm_resource_group.service_cache_rg.name
#   prefix                                   = var.prefix
#   env_short                                = var.env_short
#   name                                     = "elt"
#   location                                 = var.location
#   health_check_path                        = "api/v1/info"
#   subnet_out_id                            = module.fn_service_cache_subnet.id
#   runtime_version                          = "~3"
