...
module "apim_v2_io_backend_product" {
  source = "github.com/pagopa/terraform-azurerm-v3//api_management_product?ref=v8.26.5"
...
module "apim_v2_io_backend_bpd_api_v1" {
  source = "github.com/pagopa/terraform-azurerm-v3//api_management_api?ref=v8.26.5"
  ...
  description  = "${local.apim_v2_io_backend_api.description} - bpd"
  display_name = "${local.apim_v2_io_backend_api.display_name} - bpd"
  path         = "bpd/api"
  protocols    = ["https"]
...
module "apim_v2_io_backend_pagopa_api_v1" {
  ...
  description  = "${local.apim_v2_io_backend_api.description} - pagopa"
  display_name = "${local.apim_v2_io_backend_api.display_name} - pagopa"
  path         = "pagopa/api"
  protocols    = ["https"]
...
module "apim_v2_io_backend_auth_api_v1" {
  ...
  description  = "${local.apim_v2_io_backend_api.description} - auth"
  display_name = "${local.apim_v2_io_backend_api.display_name} - auth"
  path         = "${local.apim_v2_io_backend_api.path}/auth"
  protocols    = ["https"]
...
module "apim_v2_io_backend_cgn_api_v1" {
  ...
  description  = "${local.apim_v2_io_backend_api.description} - cgn"
  display_name = "${local.apim_v2_io_backend_api.display_name} - cgn"
  path         = "${local.apim_v2_io_backend_api.path}/cgn"
  protocols    = ["https"]
