locals {
  function_devportalservicedata = {
    app_settings_commons = {
      ...
      VISIBLE_SERVICES_COMPACT_STORAGE_PATH  = "services/services-webview/test-visible-services-compact.json"
      VISIBLE_SERVICES_EXTENDED_STORAGE_PATH = "services/services-webview/test-visible-services-extended.json"
