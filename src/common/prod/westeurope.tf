...
module "app_backend_weu" {
  ...
  allowed_subnets               = concat(data.azurerm_subnet.services_snet.*.id, [module.application_gateway_weu.snet.id, module.apim_itn.snet.id, module.platform_api_gateway_apim_itn.id])
  slot_allowed_subnets          = concat([local.azdoa_snet_id["weu"]], data.azurerm_subnet.services_snet.*.id, [module.application_gateway_weu.snet.id, module.apim_itn.snet.id, module.platform_api_gateway_apim_itn.id, module.github_runner_itn.subnet.id])
...
module "app_backend_li_weu" {
  ...
  allowed_subnets = concat(data.azurerm_subnet.services_snet.*.id,
    [
      ...
      module.platform_api_gateway_apim_itn.id
  ])
  slot_allowed_subnets = concat([local.azdoa_snet_id["weu"]], data.azurerm_subnet.services_snet.*.id, [data.azurerm_subnet.admin_snet.id, module.github_runner_itn.subnet.id, module.platform_api_gateway_apim_itn.id, module.platform_api_gateway_apim_itn.id])
