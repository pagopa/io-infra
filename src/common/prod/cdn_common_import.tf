...
import {
  ...
  id = "/subscriptions/ec285037-c673-4f58-b594-d7c480da4e8b/resourceGroups/io-p-rg-common/providers/Microsoft.Cdn/profiles/io-p-cdn-common/associations/io-p-cdnendpoint-assets"
}

import {
  to = module.common_cdn.azurerm_cdn_frontdoor_custom_domain_association.developer_io_italia_it
  id = "/subscriptions/ec285037-c673-4f58-b594-d7c480da4e8b/resourceGroups/io-p-rg-common/providers/Microsoft.Cdn/profiles/io-p-cdn-common/associations/io-p-cdnendpoint-developerportal"
}

import {
  to = module.common_cdn.azurerm_cdn_frontdoor_custom_domain_association.io_italia_it
  id = "/subscriptions/ec285037-c673-4f58-b594-d7c480da4e8b/resourceGroups/io-p-rg-common/providers/Microsoft.Cdn/profiles/io-p-cdn-common/associations/io-p-cdnendpoint-iowebsite"
}

import {
  to = module.common_cdn.azurerm_cdn_frontdoor_custom_domain_association.static_web_io_italia_it
  id = "/subscriptions/ec285037-c673-4f58-b594-d7c480da4e8b/resourceGroups/io-p-rg-common/providers/Microsoft.Cdn/profiles/io-p-cdn-common/associations/io-p-cdnendpoint-websiteassets"
}
