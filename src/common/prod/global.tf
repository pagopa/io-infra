module "global" {
  ...
  dns = {
    ...
    app_gateway_public_ip = [module.application_gateway_itn.public_ip.address] #[module.application_gateway_weu.public_ip.address, module.application_gateway_itn.public_ip.address]
