locals {
  ip_range_filter = toset(["52.174.88.118", "40.91.208.65", "13.69.64.208/28", "13.69.71.192/27", "13.93.36.78", "20.86.93.32/27", "20.86.93.64/28", "20.126.243.151", "20.126.241.238", "20.103.132.139", "20.103.131.1", "4.232.13.123", "4.232.13.98"])
  cosmosdb_containers = [
    {
      name                  = "activations"
