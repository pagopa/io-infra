locals {
  ...
  old_name = "${var.project_legacy}-appgateway" # REMOVE IF NOT USED
  ...
  trusted_client_certificates = [] # ⚠️ Remove this line and uncomment the configuration below after AGW creation ⚠️
  ...
  backends = {} # ⚠️ Remove this line and uncomment the configuration below after AGW creation ⚠️
  # backends = {
  #   apim = {
  #     protocol                    = "Https"
  ...
  listeners = {} # ⚠️ Remove this line and uncomment the configuration below after AGW creation ⚠️
  # listeners = {
  ...
  ssl_profiles = [] # ⚠️ Remove this line and uncomment the configuration below after AGW creation ⚠️
  # ssl_profiles = [{
  ...
  routes_path_based = {} # ⚠️ Remove this line and uncomment the configuration below after AGW creation ⚠️
  # routes_path_based = {
  #   app-backend-io-italia-it = {
  ...
  url_path_map = {} # ⚠️ Remove this line and uncomment the configuration below after AGW creation ⚠️
  # url_path_map = {
  ...
  routes = {} # ⚠️ Remove this line and uncomment the configuration below after AGW creation ⚠️
  # routes = {
  #   api-io-pagopa-it = {
