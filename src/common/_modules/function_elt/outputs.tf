output "function_app_elt" {
  value = {
    id                    = module.function_elt_itn.id
    name                  = module.function_elt_itn.name
    app_service_plan_name = module.function_elt_itn.app_service_plan_name
    resource_group_name   = module.function_elt_itn.resource_group_name
  }
}
output "storage_account_elt" {
  value = {
    id   = module.storage_account_itn_elt.id
    name = module.storage_account_itn_elt.name
  }
}

output "storage_account_elt_primary_access_key" {
  value     = module.storage_account_itn_elt.primary_access_key
  sensitive = true
}
