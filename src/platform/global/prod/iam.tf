...
resource "azurerm_role_assignment" "apim_client_role" {
  ...
  scope = "/subscriptions/ec285037-c673-4f58-b594-d7c480da4e8b/resourceGroups/io-p-itn-common-rg-01/providers/Microsoft.ApiManagement/service/io-p-itn-apim-01" # TODO: retrieve data from APIM remote state
}
