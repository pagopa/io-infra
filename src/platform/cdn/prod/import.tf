...
import {
  to = module.common.azurerm_cdn_frontdoor_profile.common
...
import {
  to = module.common.azurerm_cdn_frontdoor_custom_domain.assets_io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_custom_domain.developer_io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_custom_domain.io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_custom_domain.static_web_io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_custom_domain.assets_io_italia_it_legacy
...
import {
  to = module.common.azurerm_cdn_frontdoor_custom_domain.developer_io_italia_it_legacy
...
import {
  to = module.common.azurerm_cdn_frontdoor_custom_domain.io_italia_it_legacy
...
import {
  to = module.common.azurerm_cdn_frontdoor_custom_domain.static_web_io_italia_it_legacy
...
import {
  to = module.common.azurerm_dns_txt_record.assets_io_italia_it
...
import {
  to = module.common.azurerm_dns_txt_record.static_web_io_italia_it
...
import {
  to = module.common.azurerm_dns_cname_record.assets_io_italia_it
...
import {
  to = module.common.azurerm_dns_cname_record.developer_io_italia_it
...
import {
  to = module.common.azurerm_dns_a_record.io_italia_it
...
import {
  to = module.common.azurerm_dns_cname_record.static_web_io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_endpoint.assets_io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_endpoint.developer_io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_endpoint.io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_endpoint.static_web_io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_secret.developer_io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_secret.io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_origin_group.assets_io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_origin_group.developer_io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_origin_group.io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_origin_group.static_web_io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_origin.assets_io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_origin.developer_io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_origin.io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_origin.static_web_io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_route.assets_io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_route.developer_io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_route.io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_route.static_web_io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_custom_domain_association.assets_io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_custom_domain_association.developer_io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_custom_domain_association.io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule_set.assets_io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule_set.developer_io_italia_it
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule_set.io_italia_it
...
import {
  ...
  to = module.common.azurerm_cdn_frontdoor_rule.assets_io_italia_it_global_cache
}
...
import {
  ...
  to = module.common.azurerm_cdn_frontdoor_rule.assets_io_italia_it_services_data_cache
}
...
import {
  ...
  to = module.common.azurerm_cdn_frontdoor_rule.assets_io_italia_it_bonus_cache
}
...
import {
  ...
  to = module.common.azurerm_cdn_frontdoor_rule.assets_io_italia_it_status_cache
}

# Developer Portal

import {
  to = module.common.azurerm_cdn_frontdoor_rule.developer_io_italia_it_enforce_https
...
# IO Italia
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_global
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_enforce_https
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_fix_dots
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_fix_dots2
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_redirect_firma
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_faq
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_documenti_su_io_faq
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_carta_giovani_faq
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_funzionalita_dismessa
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_giornalisti
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_pubbliche_amministrazioni
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_enti_nazionali
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_cittadini
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_cgn_guida_beneficiari
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_cgn_informativa_beneficiari
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_cgn_informative_operatori
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_note_legali
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_privacy_policy
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_informativa_newsletter
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_same_path
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_homepage
...
import {
  to = module.common.azurerm_cdn_frontdoor_rule.io_italia_it_io_web
