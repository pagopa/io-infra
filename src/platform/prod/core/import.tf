...
import {
  to = module.dns.module.zones.azurerm_dns_a_record.api_app_io_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_dns_a_record.api_internal_io_italia_it
...
import {
  to = module.dns.module.zones.azurerm_dns_a_record.api_io_italia_it
...
import {
  to = module.dns.module.zones.azurerm_dns_a_record.api_io_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_dns_a_record.api_mtls_io_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_dns_a_record.api_web_io_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_dns_a_record.app_backend_io_italia_it
...
import {
  to = module.dns.module.zones.azurerm_dns_a_record.continua_io_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_dns_a_record.developerportal_backend_io_italia_it
...
import {
  to = module.dns.module.zones.azurerm_dns_a_record.firmaconio_selfcare_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_dns_a_record.licences_ipatente_io_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_dns_a_record.oauth_io_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_dns_a_record.openid_provider_io_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_dns_a_record.payments_ipatente_io_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_dns_a_record.practices_ipatente_io_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_dns_a_record.selfcare_io_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_dns_a_record.vehicles_ipatente_io_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_dns_caa_record.firmaconio_selfcare_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_dns_caa_record.io_italia_it
...
import {
  to = module.dns.module.zones.azurerm_dns_caa_record.io_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_dns_caa_record.ioapp_it
...
import {
  to = module.dns.module.zones.azurerm_dns_caa_record.ipatente_io_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_dns_cname_record.aws_cert_validation_ioweb
...
import {
  to = module.dns.module.zones.azurerm_dns_cname_record.continua
...
import {
  to = module.dns.module.zones.azurerm_dns_cname_record.firmaconio
...
import {
  to = module.dns.module.zones.azurerm_dns_cname_record.sender
...
import {
  to = module.dns.module.zones.azurerm_dns_cname_record.zendesk
...
import {
  to = module.dns.module.zones.azurerm_dns_ns_record.firma_io_pagopa_it_ns
...
import {
  to = module.dns.module.zones.azurerm_dns_ns_record.ipatente_io_pagopa_it_ns
...
import {
  to = module.dns.module.zones.azurerm_dns_txt_record.cie_app_io_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_dns_txt_record.dmarc_ioapp_it
...
import {
  to = module.dns.module.zones.azurerm_dns_txt_record.io_italia_it
...
import {
  to = module.dns.module.zones.azurerm_dns_txt_record.spf_ioapp_it
...
import {
  to = module.dns.module.zones.azurerm_dns_txt_record.zendeskverification_io_italia_it
...
import {
  to = module.dns.module.zones.azurerm_dns_zone.firmaconio_selfcare_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_dns_zone.io_italia_it
...
import {
  to = module.dns.module.zones.azurerm_dns_zone.io_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_dns_zone.ioapp_it
...
import {
  to = module.dns.module.zones.azurerm_dns_zone.ipatente_io_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_dns_zone.wallet_io_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_private_dns_a_record.api_app_internal_io
...
import {
  to = module.dns.module.zones.azurerm_private_dns_a_record.proxy_internal_io
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone.azure_api_net
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone.internal_io_pagopa_it
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone.management_azure_api_net
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone.privatelink_azurecr_io
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone.privatelink_azurewebsites
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone.privatelink_blob_core
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone.privatelink_documents
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone.privatelink_file_core
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone.privatelink_itn_containerapps
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone.privatelink_mongo_cosmos
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone.privatelink_mysql_database_azure_com
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone.privatelink_postgres_database_azure_com
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone.privatelink_queue_core
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone.privatelink_redis_cache
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone.privatelink_servicebus
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone.privatelink_srch
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone.privatelink_table_core
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone.privatelink_vault
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone.scm_azure_api_net
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.azure_api_net_vnet_common["itn"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.azure_api_net_vnet_common["weu"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.azurewebsites_private_vnet["itn"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.azurewebsites_private_vnet["weu"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.blob_core_private_vnet["itn"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.blob_core_private_vnet["weu"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.documents_private_vnet["itn"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.documents_private_vnet["weu"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.file_core_private_vnet["itn"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.file_core_private_vnet["weu"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.internal_io_pagopa_it_private_vnet["itn"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.internal_io_pagopa_it_private_vnet["weu"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.management_azure_api_net_vnet_common["itn"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.management_azure_api_net_vnet_common["weu"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.mongo_cosmos_private_vnet["itn"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.mongo_cosmos_private_vnet["weu"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.privatelink_azurecr_io_vnet["itn"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.privatelink_azurecr_io_vnet["weu"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.privatelink_itn_containerapps_vnet_common["itn"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.privatelink_itn_containerapps_vnet_common["weu"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.privatelink_mysql_database_azure_com_vnet["itn"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.privatelink_mysql_database_azure_com_vnet["weu"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.privatelink_postgres_database_azure_com_vnet["itn"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.privatelink_postgres_database_azure_com_vnet["weu"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.queue_core_private_vnet["itn"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.queue_core_private_vnet["weu"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.redis_private_vnet["itn"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.redis_private_vnet["weu"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.scm_azure_api_net_vnet_common["itn"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.scm_azure_api_net_vnet_common["weu"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.servicebus_private_vnet["itn"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.servicebus_private_vnet["weu"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.srch_private_vnet_common["itn"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.srch_private_vnet_common["weu"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.table_core_private_vnet["itn"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.table_core_private_vnet["weu"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.vault_private_vnet_common["itn"]
...
import {
  to = module.dns.module.zones.azurerm_private_dns_zone_virtual_network_link.vault_private_vnet_common["weu"]
